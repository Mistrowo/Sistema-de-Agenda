...
<head>
    ...
    <link href={{ asset('css/calendarioglobal.css') }} rel='stylesheet' />
...
<body>
  ...
  <div class="container">
    ...
    <div class="main-title">AGENDA INSTALACIONES GLOBAL</div>
    <div class="side-content">
      ...
      <div class="section-container">
            ...
            <div class="comandos-container">
              ...
              <button class="comando-btn" onclick="window.location.href='{{ route('calendario') }}';">
        ...
        <div class="schedule-container">
          ...
          <div class="schedule-row">
            ...
            <div class="data-block" id="bloque-a1-8">
                ...
                @endphp
               @foreach ($agendaItems as $item)
               <div class="{{ $item->estado  }}" data-fecha-instalacion="{{ $item->calendarioDef->fecha_instalacion }}">
                   NV:{{ $item->nota_venta }}<br>
                   Cliente:{{ $item->calendarioDef->cliente }}<br>
           ...
           @endforeach
            ...
            <div class="data-block" id="bloque-a1-9">
                ...
                @endphp
                    ...
                    NV:{{ $item->nota_venta }}<br>
                    Cliente:{{ $item->calendarioDef->cliente }}<br>
                    Fecha Instalación: {{ $item->calendarioDef->fecha_instalacion }}

                    @endforeach
                </div>
            @endif
            </div> 
            <div class="data-block" id="bloque-a1-10">
        ...
        <div class="schedule-row">
            ...
            <div class="data-block" id="bloque-a2-8">
                @if (isset($instaladoresPorBloque['KHEMNOVA']))
                @php
                    $primerItem = $instaladoresPorBloque['KHEMNOVA'][0];
                                $clasesEstado = [
            ...
            <div class="data-block" id="bloque-a2-9">
            ...
            <div class="data-block" id="bloque-a2-10">
                @if (isset($instaladoresPorBloque['STORETEK']))
                @php
                    $primerItem = $instaladoresPorBloque['STORETEK'][0];
                                $clasesEstado = [
      ...
      <div class="schedule-row">
        ...
        <div class="data-block" id="bloque-a3-8">
        ...
        <div class="data-block" id="bloque-a3-9">
            @if (isset($instaladoresPorBloque['SAN JOAQUIN']))
            @php
                $primerItem = $instaladoresPorBloque['SAN JOAQUIN'][0];
                                $clasesEstado = [
        ...
        <div class="data-block" id="bloque-a3-10">
            @if (isset($instaladoresPorBloque['STORETEK']))
            @php
                $primerItemConfirmar = $instaladoresPorBloque['STORETEK'][0];
                $primerItem = $instaladoresPorBloque['STORETEK'][0];
                                $clasesEstado = [
                                'Calendarizado' => 'estado-calendarizado',
                                'En espera' => 'estado-en-espera',
    ...
    <div class="schedule-row">
        ...
        <div class="data-block" id="bloque-a4-8">
            @if (isset($instaladoresPorBloque['KHEMNOVA']))
            @php
                $primerItem = $instaladoresPorBloque['KHEMNOVA'][0];
                                $clasesEstado = [
        ...
        <div class="data-block" id="bloque-a4-9">
        ...
        <div class="data-block" id="bloque-a4-10">
  ...
  <div class="schedule-row">
    ...
    <div class="data-block" id="bloque-a5-8">
        @if (isset($instaladoresPorBloque['KHEMNOVA']))
        @php
            $primerItem = $instaladoresPorBloque['KHEMNOVA'][0];
                                $clasesEstado = [
    ...
    <div class="data-block" id="bloque-a5-9">
        @if (isset($instaladoresPorBloque['SAN JOAQUIN']))
        @php
            $primerItem = $instaladoresPorBloque['SAN JOAQUIN'][0];
                                $clasesEstado = [
    ...
    <div class="data-block" id="bloque-a5-10">
        
        @if (isset($instaladoresPorBloque['STORETEK']))
        @php
            $primerItem = $instaladoresPorBloque['ST0RETEK'][0];
                                $clasesEstado = [
                                'Calendarizado' => 'estado-calendarizado',
                                'En espera' => 'estado-en-espera',
                                'Post-Venta' => 'estado-post-venta'
    ...
    @endif
          ...
          <div class="schedule-row">
            ...
            <div class="data-block" id="bloque-a6-8">
            ...
            <div class="data-block" id="bloque-a6-9">
            ...
            <div class="data-block" id="bloque-a6-10">
                @if (isset($instaladoresPorBloque['STORETEK']))
                @php
                    $primerItem = $instaladoresPorBloque['STORETEK'][0];
                                $clasesEstado = [
    ...
    <div class="schedule-row">
        ...
        <div class="data-block" id="bloque-a7-8">
            @if (isset($instaladoresPorBloque['KHEMNOVA']))
            @php
                $primerItem = $instaladoresPorBloque['KHEMNOVA'][0];
                                $clasesEstado = [
        ...
        <div class="data-block" id="bloque-a7-9">+
            @if (isset($instaladoresPorBloque['SAN JOAQUIN']))
            @php
                $primerItem = $instaladoresPorBloque['SAN JOAQUIN'][0];
                                $clasesEstado = [
        ...
        <div class="data-block" id="bloque-a7-10">
            @if (isset($instaladoresPorBloque['STORETEK']))
            @php
                $primerItem = $instaladoresPorBloque['STORETEK'][0];
                                $clasesEstado = [
    ...
    <div class="schedule-row">
        ...
        <div class="data-block" id="bloque-a8-8">
            @if (isset($instaladoresPorBloque['KHEMNOVA']))
            @php
                $primerItem = $instaladoresPorBloque['KHEMNOVA'][0];
                                $clasesEstado = [
        ...
        <div class="data-block" id="bloque-a8-9"> 
        ...
        <div class="data-block" id="bloque-a8-10"> @if (isset($instaladoresPorBloque['STORETEK']))
            @php
                $primerItem = $instaladoresPorBloque['STORETEK'][0];
                                $clasesEstado = [
                                'Calendarizado' => 'estado-calendarizado',
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        var fechasInstalacion = @json($fechasInstalacion);
        var indiceActual = 0; 

        function actualizarFechaYAgenda() {
            var fechaActual = fechasInstalacion[indiceActual];
            document.getElementById('todayDate').innerText = fechaActual;

            document.querySelectorAll('[data-fecha-instalacion]').forEach(function(elemento) {
                if (elemento.getAttribute('data-fecha-instalacion') === fechaActual) {
