    ...
    <div class="bg-white rounded-2xl shadow-2xl w-full max-w-2xl max-h-[90vh] overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-cyan-100 to-blue-100 px-6 py-4 border-b border-blue-200">
            <div class="flex items-center justify-between">
                ...
                <button onclick="cerrarModalSeleccionDias()" 
        ...
        <div class="bg-slate-50 border-b border-slate-200 px-6 py-4">
            <div class="flex items-center justify-between">
                ...
                <span id="mesAnio" class="text-lg font-bold text-gray-800 capitalize"></span>
        ...
        <!-- Calendario -->
        <div class="p-6 overflow-y-auto max-h-[50vh]" id="calendarioContainer">
...
<style>
/* Estilos para el calendario generado dinámicamente */
#calendario {
    display: grid;
...
#calendario .dia.seleccionado:hover {
